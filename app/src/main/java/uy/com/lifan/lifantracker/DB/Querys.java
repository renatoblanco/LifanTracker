...
public class Querys {
    ...
    public static final String QRY_ADVANCED_SEARCH = "select * from android.lifan_android_locations loc, m_productionplan pp where pp.z_vin = loc.vin and pp.z_vin ilike '%%%s%%' and z_engine ilike '%%%s%%'";
